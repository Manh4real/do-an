...
import { withRelatedProducts } from "hoc";

const RelatedProductsCarousel = React.forwardRef(
  (
    {
      objectIDs,
      fallbackComponent,
...
const Carousel = withRelatedProducts(CarouselProduct, "#carousel");

export default withScrollControl(RelatedProductsCarousel);

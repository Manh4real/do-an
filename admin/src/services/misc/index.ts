...
export const getManufacturers = async (options: AxiosRequestConfig<{ signal: GenericAbortSignal }> = {}) => {
    try {
...
export const getProductTypes = async (options: AxiosRequestConfig<{ signal: GenericAbortSignal }> = {}) => {
    try {

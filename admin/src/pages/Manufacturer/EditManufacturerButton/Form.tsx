...
import { useEditFormStore } from "../../../store/manufacturer/editForm";
import { useRefreshContext } from "../../../context";
import { updateManufacturer } from "../../../services/manufacturers";
...
function Form({ manufacturer, handleClose }: Props) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (body) {
      setLoading(true);
      updateManufacturer(manufacturer.manufacturer_id, body)
        .then(() => {
          handleClose();

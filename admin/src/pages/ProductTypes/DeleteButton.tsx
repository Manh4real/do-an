...
import { deleteProductType } from "../../services/product_types";

interface Props {
  typeId: string;
}
function DeleteButton({ typeId }: Props) {
  ...
  const handleDelete = (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    deleteProductType(typeId)
      ...
      .catch(() => {
        alert("Delete Product Type Error: Something went wrong!");
      })
      .finally(() => {
        setLoading(false);
      });
        ...
        <Modal>
          ...
          <p className="text-lg font-medium text-center my-3">
            ...
            <small className="font-normal italic text-red-500">
              Doing this also leads to delete all products of this type
            </small>
          </p>
